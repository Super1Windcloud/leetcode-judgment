                ...
                <ResizablePanelGroup direction="horizontal" className="h-full w-full">
                    ...
                    <ResizablePanel defaultSize={50} minSize={20}>
                        <div className="h-full flex flex-col bg-white dark:bg-[#292b2c] ">
                            ...
                            >
                                <div
                                    className="px-4 border-b border-zinc-200 dark:border-[#383a3c] bg-[#f8f9fa] dark:bg-[#292b2c]  flex items-center justify-between shrink-0 h-10">
                                        ...
                                        <ScrollArea className="h-full bg-zinc-50 dark:bg-transparent  p-6">
                                            {isSubmitting ? (
                                                ...
                                                <div className="space-y-6">
                                                    ...
                                                    {submissionResult.Done.status_value !== 0 && (
                                                        <div
                                                            className="bg-red-50 dark:bg-red-900/10 p-4 rounded-lg border border-red-200 dark:border-red-900/20">
                                                            <p className="text-xs text-red-500 uppercase mb-2 font-bold">
                                                                {tProblem("errorDetails")}
                                                            </p>
                                                            <pre
                                                                className="text-xs text-red-600 dark:text-red-400 whitespace-pre-wrap overflow-x-auto">
