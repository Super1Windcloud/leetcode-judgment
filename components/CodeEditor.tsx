...
export function CodeEditor({
    ...
    const handleFormat = React.useCallback(() => {
        if (editorRef.current) {
            ...
            //Todo: need add  comprehensive format check
            ...
            <div className="flex items-center  justify-between  h-9.5  bg-[#292b2c]  border-zinc-800">
                <div className="flex items-center gap-0">
                    <Select value={language} onValueChange={onLanguageChange}>
                        <SelectTrigger
                            className="w-35  pl-3  h-9.5 px-0! py-0! m-0 rounded-none bg-[#292b2c] border-none! text-zinc-100 text-xs leading-tight  shadow-none! focus:ring-0">
                    ...
                    <Select value={editorTheme} onValueChange={handleThemeChange}>
                        <SelectTrigger
                            className="w-52  pl-3  h-9.5 px-0! py-0! m-0 rounded-none bg-[#292b2c] border-none! text-zinc-100 text-xs leading-tight  shadow-none! focus:ring-0">
                        ...
                        <>
                            ...
                            <ResizablePanel defaultSize={25} minSize={10}>
                                <div className="h-full flex flex-col bg-[#1e1e1e] border-t border-zinc-800">
                                    <div
                                        className="flex items-center gap-2 px-3 h-8 bg-[#252526] text-zinc-400 text-[10px] uppercase tracking-wider font-bold shrink-0">
