...
class CanvAscii {
	...
	render() {
		...
		// Change Math.sin(time) to time to make waves flow instead of swaying back and forth
		(this.mesh.material as THREE.ShaderMaterial).uniforms.uTime.value = time;

		// Comment out updateRotation to disable 3D tilting based on mouse movement
		// this.updateRotation();
